...
def arg_parse():
    ...
    parser.add_argument('--confidence_threshold',
                        default=getenv('confidence_threshold'),
                        type=float,
                        help='confidence_threshold')

    parser.add_argument('--top_k',
                        default=getenv('top_k'),
                        type=int,
                        help='top_k')

    parser.add_argument('--nms_threshold',
                        default=getenv('nms_threshold'),
                        type=float,
                        help='nms_threshold')
    ...
    parser.add_argument('--keep_top_k',
                        default=getenv('keep_top_k'),
                        type=int,
                        help='keep_top_k')

    parser.add_argument('--vis_thres',
                        default=getenv('vis_thres'),
                        type=float,
...
def main():
    ...
    if is_video(extension):
        ...
        output = args.output_dir + filename + '.avi'
